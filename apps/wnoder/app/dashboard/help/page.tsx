...
import { HelpCircle, LayoutDashboard, Cpu, DollarSign, Users, Settings, ChevronDown, ChevronRight, Zap, Mail, ExternalLink, Shield, CreditCard, Server } from 'lucide-react';
        ...
        items: [
            {
                ...
                answer: 'You earn money from two sources:\n\n1. Hardware Yield — Revenue generated when your nodes process compute jobs on the mesh. The more powerful your hardware and the longer it stays online, the more you earn.\n\n2. Affiliate Earnings — Commission from your affiliate network. You earn 2% on revenue generated by your Level 1 (direct) affiliates and 6% on Level 2 affiliates.'
            },
            {
                question: 'When are payouts made?',
                answer: 'Funds are settled every 24 hours automatically. The settlement is processed via the secure mesh payment layer and deposited into your connected Stripe account. You can view the settlement history in the Summary Ledger on the Money page.'
            },
            {
            ...
            },
            {
                ...
                answer: 'The Summary Ledger shows your aggregated revenue across four timeframes: Last 24 Hours, Last Week, Last Month, and Last Year. Click any row to open the Revenue Itemization Breakdown, which splits your income into Own Revenue, L1 Affiliate Earnings, and L2 Affiliate Earnings.'
            },
            {
        ...
        items: [
            {
                ...
                answer: 'When you invite someone to join Wnode using your personal invite link, they become your Level 1 (L1) affiliate. When those people invite others, the new signups become your Level 2 (L2) affiliates.\n\nYou earn a 2% commission on all revenue generated by your L1 affiliates and a 6% commission on L2 affiliate revenue. This is passive income — it accrues automatically as their nodes process jobs.'
            },
            {
            ...
            },
            {
                ...
                answer: 'This is the total commission you have earned from both L1 and L2 affiliates combined. It is the sum of 2% of all L1 revenue plus 6% of all L2 revenue. This figure is settled daily alongside your hardware yield.'
            },
        ],
    },
    {
