            ...
            >
                ...
                >
                    ...
                    <div className="p-4 bg-black/40 border border-white/10 rounded font-mono text-xs text-left text-gray-400 mb-8">
                        [TRACE] POLICY_VIOLATION_DETECTED<br/>
                        [RULE] ONE_MACHINE_ONE_NODE (1M1N)<br/>
                        [STATUS] ACCOUNT_SCORE_ZEROED<br/>
                        [ACTION] EARNINGS_HALTED_PENDING_REVIEW
                    </div>
                    
                    <p className="text-xs text-slate-500 mb-8 leading-relaxed">
                        Nodl enforces a strict 1M1N policy to ensure mesh decentralization. 
                        If you believe this is an error, please contact <span className="text-[#22D3EE] cursor-pointer">Sovereign Support</span>.
                    </p>
