    ...
    const sections = [
        ...
        },
        {
            ...
            items: [
                ...
                "Automatic Transfers: Earnings are processed and managed entirely within the Stripe ecosystem.",
                "Ledger: View your earned revenue itemized on the Finances dashboard."
            ]
        },
        {
            title: "Node Health",
