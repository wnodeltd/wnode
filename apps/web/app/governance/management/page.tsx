        ...
        <AppLayout>
            <div className="bg-black text-white min-h-screen pt-40 pb-20 px-8">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="p-12 border border-white/25 bg-white/5 rounded-[2.5rem] space-y-10">
                        <h3 className="text-2xl font-bold uppercase tracking-[0.2em] text-blue-400 border-b border-white/25 pb-6">Wnode Economic Constitution</h3>
