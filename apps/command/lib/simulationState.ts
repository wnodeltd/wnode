...
export const resetSimulation = () => {
    simulationState.pricingTiers = [
        ...
        { id: 'decc-tee', name: 'DECC Protected', cpu_cores: 8, ram_gb: 32, gpu_model: 'Encrypted Enclave', rate_th_sec: 0.0110, description: 'Secure, confidential compute environments.' },
    ...
    const founders = [
        { id: '100001-0426-01-AA', name: 'Stephen Soos', email: 'stephen@wnode.one', region: 'North America', status: 'active', crmRights: 'full', onboardingBypass: true, balance: 250000, bio: 'Founder & CEO, Nodl Protocol', org: 'Nodl', nodeCount: 3, activeNodes: 3, peers: 12, mfa: true, perms: ['admin','finance','nodes','users','settings'] },
        ...
        { id: '100003-0426-03-AA', name: 'Ava Chen', email: 'ava@wnode.one', region: 'Asia Pacific', status: 'active', crmRights: 'none', onboardingBypass: true, balance: 85000, bio: 'Head of APAC Operations', org: 'Nodl APAC', nodeCount: 2, activeNodes: 2, peers: 8, mfa: true, perms: ['nodes'] },
        { id: '100004-0426-04-AA', name: 'Marcus Thorne', email: 'marcus@wnode.one', region: 'Western Europe', status: 'active', crmRights: 'none', onboardingBypass: true, balance: 92000, bio: 'Infrastructure Lead', org: 'Nodl EU', nodeCount: 1, activeNodes: 1, peers: 5, mfa: false, perms: ['nodes'] },
        { id: '100005-0426-05-AA', name: 'Yara Hassan', email: 'yara@wnode.one', region: 'Middle East', status: 'active', crmRights: 'none', onboardingBypass: true, balance: 77000, bio: 'Regional Coordinator', org: 'Nodl ME', nodeCount: 1, activeNodes: 1, peers: 3, mfa: false, perms: ['nodes'] },
        { id: '100006-0426-06-AA', name: 'Founder 06', email: 'f06@wnode.one', region: 'Global', status: 'dormant', crmRights: 'none', onboardingBypass: true, balance: 0, bio: '', org: '', nodeCount: 0, activeNodes: 0, peers: 0, mfa: false, perms: [] },
        { id: '100007-0426-07-AA', name: 'Founder 07', email: 'f07@wnode.one', region: 'Global', status: 'dormant', crmRights: 'none', onboardingBypass: true, balance: 0, bio: '', org: '', nodeCount: 0, activeNodes: 0, peers: 0, mfa: false, perms: [] },
        { id: '100008-0426-08-AA', name: 'Founder 08', email: 'f08@wnode.one', region: 'Global', status: 'dormant', crmRights: 'none', onboardingBypass: true, balance: 0, bio: '', org: '', nodeCount: 0, activeNodes: 0, peers: 0, mfa: false, perms: [] },
        { id: '100009-0426-09-AA', name: 'Founder 09', email: 'f09@wnode.one', region: 'Global', status: 'dormant', crmRights: 'none', onboardingBypass: true, balance: 0, bio: '', org: '', nodeCount: 0, activeNodes: 0, peers: 0, mfa: false, perms: [] },
        { id: '100010-0426-10-AA', name: 'Founder 10', email: 'f10@wnode.one', region: 'Global', status: 'dormant', crmRights: 'none', onboardingBypass: true, balance: 0, bio: '', org: '', nodeCount: 0, activeNodes: 0, peers: 0, mfa: false, perms: [] },
    ];
