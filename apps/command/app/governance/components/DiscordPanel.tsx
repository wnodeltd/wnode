...
export default function DiscordPanel() {
  ...
  return (
    <div id="discord" className="bg-white/[0.02] border border-white/10 rounded-[5px] p-8 space-y-6 hover:shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all group h-[280px] flex flex-col">
