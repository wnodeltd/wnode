            ...
            <main className="flex-1 p-8 overflow-y-auto pb-24 relative custom-scrollbar h-full">
                <header className="flex flex-col gap-2 mb-10">
                    <div className="flex items-center justify-between">
                         <h1 className="text-xl font-normal tracking-tight text-white uppercase tracking-widest">Administrative Control Center</h1>
                    ...
                    <p className="text-[14px] text-slate-500 font-normal">Environmental parameters and high-privilege system overrides.</p>
                </header>
                    ...
                    <div className="xl:col-span-2 space-y-8">
                        ...
                        <section className="bg-white/[0.02] border border-white/10 rounded-[5px] overflow-hidden">
                            ...
                            <div className="divide-y divide-white/5">
                                {[
                                    { user: 'stephen@nodl.one', action: 'Update Pricing [Tier_01]', time: '10m ago', ip: '142.12.8.4' },
                                    { user: 'stephen@nodl.one', action: 'Authorize Payout #824', time: '4h ago', ip: '142.12.8.4' },
                                    { user: 'manager_1@nodl.one', action: 'Flush Node State [Cache]', time: '1d ago', ip: '18.42.102.11' },
                                ].map((log, i) => (
