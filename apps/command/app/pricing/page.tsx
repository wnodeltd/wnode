            ...
            <main className="flex-1 p-8 overflow-y-auto pb-24 relative custom-scrollbar">
                <header className="flex flex-col gap-2 mb-10">
                    <div className="flex items-center justify-between">
                        <h1 className="text-xl font-normal tracking-tight text-white uppercase tracking-widest">Pricing Protocol & Tier Matrix</h1>
                    ...
                    <p className="text-[14px] text-slate-500 font-normal">Autonomous economy management with real-time market-relative rate tuning.</p>
                </header>
